...
snpsModelTetra = c("general","additive","1-dom", "2-dom")
testModelsTetra = c("general", "additive","1-dom-alt","1-dom-ref", "2-dom-alt","2-dom-ref") 
...
data = read.GWASpoly (ploidy = PLOIDY, delim=",", format = "ACGT", n.traits = 1, 
...
data4 = set.threshold (data3, method=CORRECTION,level=0.05, n.core=4)
