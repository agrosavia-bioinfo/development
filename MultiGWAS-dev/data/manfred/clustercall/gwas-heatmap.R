...
main <- function () {
	...
	genoFilenameACGT    <- "agrosavia-genotype-ACGT-CLEANED.tbl"
	genoFilenameNUMERIC <- "agrosavia-genotype-NUM-CLEANED.tbl"
	phenoFilename       <- "train_CT.csv"


	snpList      <- c ("solcap_snp_c1_1000")         # SNPs a visualizar

	createHeatmapForSNPList ("./", genoFilenameACGT, genoFilenameNUMERIC, phenoFilename, snpList) 
}
