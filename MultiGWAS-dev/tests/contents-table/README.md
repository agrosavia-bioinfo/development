# MultiGWAS Table of Contents
   * [Installation](#installation)
      ...
      * [MultiGWAS installation:](#multigwas-nstallation)
...
# Installation:
We describe here the [MultiGWAS](https://github.com/agrosavia-bionformatics/multiGWAS-stable) installation that contains the file sources and binaries to run the MultiGWAS tool. It includes:
